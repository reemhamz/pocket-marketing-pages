  ...
  [31],
  {
    Eh6L: function (e, o, t) {
      ...
      (o.a = function (e) {
        ...
        return u(
          ...
          u(c.a, { isLoggedIn: i }),
          u(l.u, { className: "page-container" }, u("main", null, o)),
    ...
    "HaE+": function (e, o, t) {
      ...
      function a(e, o, t, a, i, n, r) {
        ...
        s.done ? o(l) : Promise.resolve(l).then(a, i);
      }
      function i(e) {
        return function () {
          var o = this,
    ...
    qTMf: function (e, o, t) {
      ...
      function u() {
        return c(
          ...
          c("h1", null, "Privacy Policy"),
          c("h5", null, c("em", null, "Posted February 16, 2021")),
          c(
            "p",
            null,
          ...
          c(
            ...
            c(
              ...
              c(
                "a",
                { href: "#passive" },
                "Collection of Information as Part of Using Pocket Service"
              )
            ),
            c(
              "li",
              null,
              c("a", { href: "#cookies" }, "Use of Cookies and Analytics")
            ),
            c("li", null, c("a", { href: "#use" }, "Use of Information")),
            c(
              "li",
              null,
              c("a", { href: "#sharing" }, "Sharing of Information")
            ),
            c("li", null, c("a", { href: "#keeping" }, "Keeping Information")),
            c(
              "li",
              null,
              c("a", { href: "#transfer" }, "Transfer of Information")
            ),
            c("li", null, c("a", { href: "#security" }, "Security")),
            c("li", null, c("a", { href: "#phishing" }, "Phishing")),
            c(
              "li",
              null,
              c(
                "a",
                { href: "#opt-out" },
                "Managing My Privacy and Email Settings"
              )
            ),
            c(
              "li",
              null,
              c("a", { href: "#amendments" }, "Amendments to Policy")
            ),
          ...
          c("h5", { id: "cookies" }, "USE OF COOKIES AND ANALYTICS"),
          c("p", null, c("strong", null, "Types and Purposes")),
          c(
            "p",
            null,
          ...
          c(
            ...
            c(
              "li",
              null,
              "Necessary: These cookies are necessary for our website to function and cannot be switched off. For example, we use them to manage your login state. You can set your browser to block or alert you about these cookies, but this may cause parts of the site to not work properly. These cookies do not store any personally identifiable information."
            ),
            c(
              "li",
              null,
              "Functional: We place these cookies on your device to remember your account preferences and language settings. Disabling these cookies may break some features."
            ),
            c(
              "li",
              null,
              "Analytics: We place these cookies on your device to help us understand in the aggregate how users engage with our website and product. For example, we use Google Analytics to understand which Pocket webpages are popular. We also use pixels in our emails in order to collect usage information. Disabling these cookies prevents us from including your engagement in our aggregate measurement."
            ),
            c(
              "li",
              null,
              "Advertising: Some Pocket web pages have ads. On those pages, our partners may place cookies on your device to measure impressions and clicks. Some partners may further use these cookies to personalize ads you see on other websites. Disabling these cookies prevents ad partners from knowing what stories you viewed on Pocket and how you engaged with ads on those pages."
            )
          ),
          c("p", null, c("strong", null, "Your Choices")),
          c(
            "ul",
            null,
            c(
              "li",
              null,
              "Cookie Preference tool: By default, Pocket sets functional and analytics cookies, and disables advertising cookies. You can manage these cookies from the",
              " ",
              c(
                "button",
                {
                  id: "ot-sdk-btn",
                  className: "ot-sdk-show-settings privacy-policy-link",
                },
                "Cookie Preferences"
              ),
              " tool.",
              ...
              c(
                ...
                {
                  href:
                    "https://help.getpocket.com/article/1163-pocket-website-cookies-faq",
                },
                "Learn more"
              ),
              "."
            ...
            c(
              "li",
              null,
              "Google\u2019s Analytics opt-out: Install the",
              " ",
              c(
                "a",
              ...
              ", which prohibits data transmission to Google Analytics."
            )
          ),
          c(
            "p",
          ...
          c("h5", { id: "use" }, "USE OF INFORMATION"),
          c(
            "p",
            null,
          ...
          c("h5", { id: "sharing" }, "SHARING OF INFORMATION"),
          c(
            "p",
            null,
          ...
          c("h6", null, "Links to other sites and apps"),
          c(
            "p",
            null,
          ...
          c("h6", null, "Working with third parties"),
          c(
            "p",
            null,
          ...
          c("h6", null, "Sharing as required by law or asset sale"),
          c(
            "p",
            null,
          ...
          c("h5", { id: "keeping" }, "KEEPING INFORMATION"),
          c(
            "p",
            null,
          ...
          c("h5", { id: "transfer" }, "TRANSFER OF INFORMATION"),
          c(
            "p",
            null,
          ...
          c("h5", { id: "opt-out" }, "MANAGING MY PRIVACY AND EMAIL SETTINGS"),
          c(
            "p",
            null,
            "You can access, correct, or delete your personal information and export your data from your Pocket Profile. You can also view and control which third party services, if any, you want to connect to your Pocket account. These settings are at:",
            " ",
            c("a", { href: "/options" }, "https://getpocket.com/options")
          ),
          c(
            "p",
            null,
          ...
          c("h5", { id: "amendments" }, "AMENDMENTS TO POLICY"),
          c(
            "p",
            null,
            "Please note this Privacy Policy will change from time to time. We may amend this Privacy Policy at any time by posting the amended terms on our Website that you can access at ",
            c("a", { href: "/" }, "getpocket.com"),
            " or through the options or help menu of the Pocket application. All amended terms shall automatically be effective thirty (30) days after they are initially posted on the Website. If we make any material changes to our Privacy Policy that affect user information already stored in our database, we will post a prominent notice on our Website notifying users that our Privacy Policy has changed. Our use of your information shall be governed by the terms and conditions of our Privacy Policy in effect when you first use our application or thirty (30) after the terms are changed, as explained above."
          ),
          c(
            "p",
            null,
            "If you have questions about any of the provisions described above, please contact us at",
            " ",
            c(
              "a",
              { href: "mailto:privacy@getpocket.com" },
              "privacy@getpocket.com"
            ),
            " or at the street address listed above."
          ),
          c("h5", { id: "contact" }, "CONTACT"),
          c(
            "p",
            null,
            ...
            c(
              "a",
              { href: "https://help.getpocket.com/contact" },
...
//# sourceMappingURL=privacy-3547d66a9d807c4e4bac.js.map
